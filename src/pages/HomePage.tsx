          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy">Standardized Format</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy">Built-in Relationships</h3>
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                <Zap className="w-5 h-5 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-brand-navy">Familiar REST Pattern</h3>
              ...
              <div className="flex items-start gap-3">
                <Shield className="w-5 h-5 text-brand-teal mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-brand-navy">Embedded Resources</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brand-navy mb-2">API Integration Patterns</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brand-navy mb-2">Content Management</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brand-navy mb-2">Decoupled Architecture</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brand-navy mb-2">Code Examples</h3>
          ...
          <div className="mt-8 text-center">
            <Link 
              to="/code-examples"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-brand-navy to-brand-teal text-white rounded-lg hover:from-brand-navy/90 hover:to-brand-teal/90 transition-all duration-200 font-medium"
            >
